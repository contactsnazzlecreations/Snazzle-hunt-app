// Snazzle AR Placement v279 — native standalone plaatsing met eigen MFA-controle.
...
function installButton(){
  ...
  const href='./snazzle-ar-place.html?v=279';
...
console.info('Snazzle AR Placement v279 native plaatslink actief');
