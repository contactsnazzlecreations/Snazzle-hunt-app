// Snazzle AR Placement v281 — directe superadminplaatsing zonder extra mailcode.
...
function installButton(){
  ...
  const href='./snazzle-ar-place.html?v=281';
...
console.info('Snazzle AR Placement v281 directe plaatslink actief');
