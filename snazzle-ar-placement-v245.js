// Snazzle AR Placement v277 — native link naar zelfstandige plaatsingspagina.
...
function installButton(){
  ...
  const href='./snazzle-ar-place.html?v=277';
...
console.info('Snazzle AR Placement v277 native plaatslink actief');
