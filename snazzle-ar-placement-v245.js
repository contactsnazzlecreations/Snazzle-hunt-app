// Snazzle AR Placement v280 — eenvoudige beheerplaatsing zonder extra mailcode.
...
function installButton(){
  ...
  const href='./snazzle-ar-place.html?v=280';
...
console.info('Snazzle AR Placement v280 eenvoudige plaatslink actief');
