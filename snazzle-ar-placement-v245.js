// Snazzle AR Placement v282 — sleepbare pin + expliciet vastzetten.
...
function installButton(){
  ...
  const href='./snazzle-ar-place.html?v=282';
...
console.info('Snazzle AR Placement v282 sleepbare pin actief');
