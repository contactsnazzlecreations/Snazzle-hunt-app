// Snazzle Hunt v261 — stabiele opstart + compleet vervangbare app-afbeeldingen.
...
function preloadCriticalAssets(){
  const moduleHrefs=[
    './app-runtime-v245.js?v=261',
    './snazzle-runtime-stability-v71.js?fresh=20260917-v261-home-backgrounds-final',
    './snazzle-image-stability-v72.js?fresh=20260917-v261-home-backgrounds-final',
    './snazzle-leaflet-isolation-v190.js?fresh=20260917-v261-home-backgrounds-final',
    './app-core.js?fresh=20260917-v261-home-backgrounds-final',
    './snazzle-core-performance-v248.js?fresh=20260917-v261-home-backgrounds-final',
    './snazzle-adventure-ui-v28.js?fresh=20260917-v261-home-backgrounds-final',
    './snazzle-clean-home-v31.js?v=261',
    './snazzle-home-card-backgrounds-v75.js?v=261'
  ];
  ...
  ['./snazzle-reference-layout.css?v=261','./snazzle-clean-home-v31.css?v=261'].forEach(href=>{
...
async function optionalImport(path,label){
  try{
    ...
    return await import(`${path}${path.includes('?')?'&':'?'}v=261`);
...
await import('./app-runtime-v245.js?v=261');
