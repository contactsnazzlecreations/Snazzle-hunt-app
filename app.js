...
import './app-core.js';
import './shop-compat.js?v=13';
import './kids-fun.js?v=13';
import './snazzle-route.js?v=13';
import './snazzle-collection.js?v=13';
import './snazzle-unlock.js?v=13';
import './image-fit.js?v=13';
...
onAuthStateChanged(auth, user => {
  ...
  shopLoaded = true;
  import('./shop.js?v=13')
    .then(()=>import('./shop-email-settings.js?v=13'))
