...
import './app-core.js';
import './shop-compat.js?v=14';
import './kids-fun.js?v=14';
import './snazzle-route.js?v=14';
import './snazzle-collection.js?v=14';
import './snazzle-unlock.js?v=14';
import './image-fit.js?v=14';
import './snazzle-world.js?v=14';
...
onAuthStateChanged(auth, user => {
  ...
  shopLoaded = true;
  import('./shop.js?v=14')
    .then(()=>import('./shop-email-settings.js?v=14'))
