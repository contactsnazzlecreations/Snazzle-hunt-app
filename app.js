// Snazzle Hunt v291 — Special Snazzles apart en direct bereikbaar vanuit Mijn vondsten.
...
function preloadCriticalAssets(){
  const moduleHrefs=[
    ...
    './snazzle-clean-home-v31.js?v=291',
    './snazzle-home-card-backgrounds-v75.js?v=291'
  ...
  ['./snazzle-reference-layout.css?v=291','./snazzle-clean-home-v31.css?v=291'].forEach(href=>{
...
async function optionalImport(path,label){
  try{
    ...
    return await import(`${path}${path.includes('?')?'&':'?'}v=291`);
...
await import('./app-runtime-v245.js?v=291');
