// Snazzle Hunt v303 — nauwkeurigere AR GPS, betrouwbare beheerlogin en blijvende vondsten.
...
async function optionalImport(path,label){
  try{
    ...
    return await import(`${path}${path.includes('?')?'&':'?'}v=303`);
...
await import('./app-runtime-v245.js?v=303');
