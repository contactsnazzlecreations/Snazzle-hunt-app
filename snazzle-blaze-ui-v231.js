// Snazzle BLAZE/UI v232 — exact dezelfde renderprocedure als werkende MYSTIC/UI.
const VERSION='232.0';
...
function installStyle(){
  ...
  s.textContent=`
    #sc2Grid .sc2-card[data-blaze-v232='1'] .sc2-media,
    #sc2VaultGrid .sc2-card[data-blaze-v232='1'] .sc2-media,
    #sc2List .sc2-row[data-blaze-v232='1'] .sc2-thumb{
    ...
    #sc2Grid .sc2-card.locked[data-blaze-v232='1'] .sn-blaze-v232-art,
    #sc2VaultGrid .sc2-card.locked[data-blaze-v232='1'] .sn-blaze-v232-art{
      filter:brightness(.46) saturate(.68) blur(3.2px)!important;transform:scale(1.065)!important;
    }
    #sc2Grid .sc2-card.unlocked[data-blaze-v232='1'] .sn-blaze-v232-art,
    #sc2VaultGrid .sc2-card.unlocked[data-blaze-v232='1'] .sn-blaze-v232-art{filter:none!important;transform:none!important}
    #sc2Grid .sc2-card[data-blaze-v232='1'] .sc2-lock,
    #sc2VaultGrid .sc2-card[data-blaze-v232='1'] .sc2-lock{z-index:90!important;color:#ffe15a!important;text-shadow:0 3px 12px #000!important}
    #sc2Grid .sc2-card[data-blaze-v232='1'] .sc2-rarity,
    #sc2Grid .sc2-card[data-blaze-v232='1'] .sc2-num,
    #sc2VaultGrid .sc2-card[data-blaze-v232='1'] .sc2-rarity,
    #sc2VaultGrid .sc2-card[data-blaze-v232='1'] .sc2-num{z-index:91!important}
...
function ensureArt(box,i){
  ...
  if(!wrap){
    ...
    wrap.className='sn-blaze-v232-art';
...
function repair(){
  ...
  document.querySelectorAll('#sc2List .sc2-row').forEach(row=>{
    ...
    row.dataset.blazeV232='1';
    if(ensureArt(row.querySelector('.sc2-thumb'),i))count++;
  });
  window.__snazzleBlazeUiV232={count,at:new Date().toISOString()};
  return count;
}
function queue(){if(queued)return;queued=true;requestAnimationFrame(()=>{queued=false;try{repair()}catch(e){console.error('BLAZE/UI v232 repair',e)}})}
