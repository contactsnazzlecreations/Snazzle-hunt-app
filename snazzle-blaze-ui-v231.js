// Snazzle BLAZE/UI v231 — exact dezelfde rendererprocedure als werkende MYSTIC/UI v227.
const VERSION='231.0';
const ATLAS='./assets/cards/snazzle-blaze-atlas-v231.jpg?v=231';
let queued=false;
...
function installStyle(){
  ...
  s.textContent=`
    ...
    #sc2List .sc2-row[data-blaze-v231='1'] .sc2-thumb{
    ...
    #sc2Grid .sc2-card.locked[data-blaze-v231='1'] .sn-blaze-v231-art,
    #sc2VaultGrid .sc2-card.locked[data-blaze-v231='1'] .sn-blaze-v231-art{
      filter:brightness(.46) saturate(.68) blur(3.2px)!important;transform:scale(1.065)!important;
    }
    #sc2Grid .sc2-card.unlocked[data-blaze-v231='1'] .sn-blaze-v231-art,
    #sc2VaultGrid .sc2-card.unlocked[data-blaze-v231='1'] .sn-blaze-v231-art{filter:none!important;transform:none!important}
    #sc2Grid .sc2-card[data-blaze-v231='1'] .sc2-lock,
    #sc2VaultGrid .sc2-card[data-blaze-v231='1'] .sc2-lock{z-index:90!important;color:#ffe15a!important;text-shadow:0 3px 12px #000!important}
    #sc2Grid .sc2-card[data-blaze-v231='1'] .sc2-rarity,
    #sc2Grid .sc2-card[data-blaze-v231='1'] .sc2-num,
    #sc2VaultGrid .sc2-card[data-blaze-v231='1'] .sc2-rarity,
    #sc2VaultGrid .sc2-card[data-blaze-v231='1'] .sc2-num{z-index:91!important}
...
function cleanBox(box){
  ...
  box.querySelectorAll(':scope > div').forEach(el=>{
    if(!el.classList.contains('sn-blaze-v231-art'))el.remove();
  });
...
function ensureArt(box,i){
  ...
  if(!wrap){
    wrap=document.createElement('div');wrap.className='sn-blaze-v231-art';
...
function repair(){
  ...
  window.__snazzleBlazeUiV231={count,at:new Date().toISOString()};
  return count;
}
